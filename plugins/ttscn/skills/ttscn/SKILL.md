---
name: ttscn
description: Multi-platform Chinese & multilingual TTS text-to-speech via Edge/Doubao/CosyVoice/Azure/Tencent/Baidu/MiniMax/Xunfei plus ElevenLabs/OpenAI/Google/Atlas Cloud — 12 backends, word-level timestamps, [PAUSE:x] pause markers, pinyin pronunciation overrides
author: Agents365-ai
version: 1.8.0
created: 2026-07-08
updated: 2026-08-13
...
Generate natural speech audio from text. **12 backends** — 8 China-friendly clouds plus 4 international or unified APIs (ElevenLabs / OpenAI / Google / Atlas Cloud).
...
| 12 | **Atlas Cloud TTS** | Per-model pricing | Unified async API, multilingual voices |
...
New in 1.8: **Atlas Cloud TTS** with asynchronous generation, bounded polling,
credential-free media download, and multilingual voice presets.
...
```bash
python3 scripts/tts.py schema backends              # All 12 backends (compact by default)
