...
# No double-billing. 7-day TTL.</code></pre>
  ...
  <footer class="footer">
    <p>Generated by <strong>ttscn</strong> · <a href="https://github.com/Agents365-ai/365-skills">GitHub</a> · CC BY-NC 4.0</p>
  </footer>
</div>
...
def build_md(data):
  ...
  lines.append("---")
  lines.append(
    "*Generated by [ttscn](https://github.com/Agents365-ai/365-skills) from `data/providers.json`*"
  )
  lines.append("")
